...
from staff.views.course.swe_fundamentals.swe_fundamentals_registration import ListView
...
def test_coding_basics_batch_registration_list_contains_registrations(coding_basics_registration, existing_user):
    ...
    assert 'course/swe_fundamentals/registration/list.html' in (template.name for template in response.templates)
