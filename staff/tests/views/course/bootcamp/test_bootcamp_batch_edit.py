...
from staff.views.course.bootcamp.bootcamp_batch import EditView
...
def test_bootcamp_batch_edit_template_rendered_for_logged_in_user(coding_bootcamp_batch, existing_user):
    ...
    assert 'course/bootcamp/batch/edit.html' in (template.name for template in response.templates)
