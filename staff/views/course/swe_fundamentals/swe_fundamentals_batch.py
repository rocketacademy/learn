...
class ListView(LoginRequiredMixin, View):
    def get(self, request):
        ...
        return render(
            request,
            'course/swe_fundamentals/batch/list.html',
            {
                'batches': batches,
            }
        )
...
class DetailView(LoginRequiredMixin, View):
    def get(self, request, batch_id):
        ...
        return render(
            request,
            'course/swe_fundamentals/batch/detail.html',
            {
...
class NewView(LoginRequiredMixin, View):
    def get(self, request):
        ...
        return render(
            request,
            'course/swe_fundamentals/batch/new.html',
            {
...
class EditView(LoginRequiredMixin, View):
    def get(self, request, batch_id):
        ...
        return render(
            request,
            'course/swe_fundamentals/batch/edit.html',
            {
                'current_tab': 'overview',
                'batch': batch,
                'batch_form': batch_form,
