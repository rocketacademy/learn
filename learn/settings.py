...
SWE_FUNDAMENTALS_COURSE_DURATION_IN_DAYS = 35
SWE_FUNDAMENTALS_REGISTRATION_FEE_SGD = 199
SWE_FUNDAMENTALS_REGISTRATION_FEE_HKD = 1149
SWE_FUNDAMENTALS_TIERED_DISCOUNT_CAP = 40
SWE_FUNDAMENTALS_TIERED_DISCOUNT_CAP_HK = 200
SWE_FUNDAMENTALS_TIERED_DISCOUNT_PER_WEEK = 10
SWE_FUNDAMENTALS_TIERED_DISCOUNT_PER_WEEK_HK = 50

# EMAILS #
ROCKET_COMMUNITY_EMAIL = 'community@rocketacademy.co'
ROCKET_EDUCATION_EMAIL = 'education@rocketacademy.co'
