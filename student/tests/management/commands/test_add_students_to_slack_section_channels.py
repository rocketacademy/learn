...
def test_only_picks_up_swe_fundamentals_batches_starting_in_7_days(mocker, enrolment_factory):
    ...
    swe_fundamentals_batch_starting_in_7_days.end_date = start_date_7_days_from_now + timedelta(settings.SWE_COURSE_DURATION_IN_DAYS)
    ...
    coding_basics_batch_starting_in_7_days.end_date = start_date_7_days_from_now + timedelta(settings.SWE_COURSE_DURATION_IN_DAYS)
    ...
    swe_fundamentals_batch_starting_in_8_days.end_date = start_date_8_days_from_now + timedelta(settings.SWE_COURSE_DURATION_IN_DAYS)
